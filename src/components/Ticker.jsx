...
<div class="ticker">
  <div class="ticker__list">
    <div class="ticker__item"><img src={image1}/></div>
    <div class="ticker__item"><img src={image2}/></div>
    <div class="ticker__item"><img src={image3}/></div>
    <div class="ticker__item"><img src={image4}/></div>
    <div class="ticker__item"><img src={image5}/></div>
